        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-12 col-xl-9">
                    {!! Form::label('cie_10_id', 'Diagnóstico') !!}
                ...
                <div class="form-group col-8 col-md-12 d-flex align-items-end justify-content-end justify-content-md-center my-3">
                    <a class="btn bg-navy" wire:click="store()">Crear incapacidad</a>
                </div>
            </div>
        </div>
    </div>
