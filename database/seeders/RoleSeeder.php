...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'administrador.user.index','description'=>'mostrar usuario'])->syncRoles([$role1]);
        Permission::create(['name'=>'administrador.user.create','description'=>'crear usuario'])->syncRoles([$role1]);
        Permission::create(['name'=>'administrador.user.edit','description'=>'editar usuario'])->syncRoles([$role1]);
        Permission::create(['name'=>'administrador.user.destroy','description'=>'eliminar usuario'])->syncRoles([$role1]);
